...
public class parser {
	...
	public String convertMove2String(Move mv, String color){
		StringBuffer sb = new StringBuffer("Move:"+color+':');
		//Move is a list of steps. Read the whole list and append to buffer.
		//example Move:Black:(5:1):(4:2)
		//where is the color?
		return sb.toString();
	}
